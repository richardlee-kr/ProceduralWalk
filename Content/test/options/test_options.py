...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--A_folder', type=str, default='mask', help='coarselabelmap,labelmap,mask,realimg')
        parser.add_argument('--B_folder', type=str, default='mask', help='coarselabelmap,labelmap,mask,realimg')
